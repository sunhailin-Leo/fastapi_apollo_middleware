...
__title__ = "fastapi_apollo_middleware"
__description__ = "A FastAPI Middleware of Apollo(Config Server By CtripCorp) " \
                  "to get server config in every request."
__url__ = "https://github.com/sunhailin-Leo/fastapi_apollo_middleware"
__author_email__ = "379978424@qq.com"
__license__ = "MIT"
__requires__ = ["fastapi", "requests"]
__keywords__ = ["fastapi", "apollo", "config server", "middleware"]
